...
$telefones = $usuario->telefones($conn,$id);
...
<div class="container col-xs-10 col-xs-offset-1 col-sm-6 col-sm-offset-3 col-md-4 col-md-offset-4">
	...
	<form action="controllers/atualizar_usuario.php" method="POST" onsubmit="validar(event)">
		<h2 class="text-center">Informe seu <b>usuário</b> e <b>senha</b> para edição de dados</h2>
		<div class="form-group">
			<div class="input-group">
  				<div class="input-group-addon">
  					<span class="glyphicon glyphicon-user"></span>
  				</div>
			<input type="text" name="nome" class="form-control" id ="nome" value="<?php echo $usuario->getNome() ?>" placeholder="Nome">
		</div>
		...
		<div class="form-group">
			...
			<input type="text" name="sobrenome"  class="form-control" id="sobrenome" value="<?php echo $usuario->getSobrenome() ?>" placeholder="Sobrenome">
		</div>
		...
		<div class="form-group">
			...
			<input type="email"  class="form-control" id="email" value="<?php echo $usuario->getEmail() ?>" name="email" placeholder="Email" >
		</div>
		...
		<input type="text" class="form-control" id="cep" name="cep" value="<?php echo $usuario->endereco($conn,$id)['cep']; ?>" placeholder="Cep">
			</div>
			...
			value="<?php echo $usuario->endereco($conn,$id)['uf']; ?>" placeholder="UF" >
			</div>
			...
			<input type="text"  class="form-control" id="cidade" name="cidade" value="<?php echo $usuario->endereco($conn,$id)['cidade']; ?>" placeholder="Cidade" >
			</div>
			...
			<input type="text"  class="form-control" id="rua" name="rua" value="<?php echo $usuario->endereco($conn,$id)['rua']; ?>" placeholder="Rua" >
			</div>
			...
			<input type="text"  class="form-control" id="bairro" name="bairro" value="<?php echo $usuario->endereco($conn,$id)['bairro']; ?>"  placeholder="Bairro" >
			</div>
			...
			<input type="text"  class="form-control" id="numero" name="numero" value="<?php echo $usuario->endereco($conn,$id)['numero']; ?>" placeholder="Numero" >
			</div>
			...
			<input type="text"  class="form-control" id="complemento" name="complemento" value="<?php echo $usuario->endereco($conn,$id)['complemento']; ?>" placeholder="Complemento" >
			</div>
		...
		<div class="input-group">
			...
			<input type="text"  class="form-control" name="telefones[0][numero]" placeholder="Celular" value="<?php echo $telefones["celular"]; ?>" id="numeroCel">
		...
		<div class="input-group">
			...
			<input type="text"  class="form-control" name="telefones[1][numero]" placeholder="Residencial" value="<?php echo $telefones["residencial"]; ?>" id="numeroRes">
			</div>
		...
		<div class="input-group">
			...
			<input type="text"  class="form-control" name="telefones[2][numero]" placeholder="Comercial" value="<?php echo $telefones["comercial"]; ?>" id="numeroCom">
			</div>
